...
public class GroupPageAdapter extends RecyclerView.Adapter<GroupPageAdapter.personViewHolder>  {
    ...
    public GroupPageAdapter(Context context, List<List_Users> personList, RecyclerViewClickInterface recyclerViewClickInterface) {
...
//        });
    ...
    public void onBindViewHolder(@NonNull personViewHolder holder, int position) {
        ...
        try{
                ...
                holder.personImage.setImageResource(R.drawable.group);
