...
//        getOnBackPressedDispatcher().addCallback(this, callback);
        ...
        try {
            ...
            chatid = bundle.getString("chat_id");
        }
        catch (Exception e){
    ...
    private void update_lastmsg(final String msg){
        ...
        db.collection("Group").document(chatid).set(lastmsg,SetOptions.merge());
    ...
    private void updateUIfirebase(FirebaseUser account) {
        if (account == null) {
            ...
            camera.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    CropImage.startPickImageActivity(ChatGroup.this);
                }
            });
            ...
            try {
                if (!person_dp.isEmpty())
                Picasso.get().load(person_dp).into(dp_chat);
                else{
                    dp_chat.setImageResource(R.drawable.group);
                    int color = Color.parseColor("#ffffff");
                    dp_chat.setColorFilter(color);
                }
            }
            catch (Exception e){
                dp_chat.setImageResource(R.drawable.group);
                ...
                userName.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.putExtra("person", my_id);
                        intent.putExtra("group_id",chatid);
                        intent.putExtra("arrUsers","");
                        startActivity(intent);
